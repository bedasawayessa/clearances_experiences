...
?>
                ...
                <table class="table table-bordered" border='1'>
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM clearances_tbl WHERE UserID = '$user_id'";
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td><a href='edit_request.php?id=" . $row["ClearanceID"] . "'>Edit</a> | <a href='delete_request.php?id=" . $row["ClearanceID"] . "'>Delete</a></td>";
                            echo "</tr>";
                        }
                        ?>
                    </tbody>
