                    ...
                    <div class="addNewUserForm row">
                        ...
                        <div class="items">
                            <div class="mb-2">
                                ...
                                <select class="form-select" id="exampleRoleSelect" name="role" aria-describedby="roleHelp" required>

                                    <?php
                                    $roles = array("admin", "officers", "librarian", "instructor", "staff", "student", "hrm", "user"); // Add more roles as needed
    foreach ($roles as $role) {
        // Check if $row["role"] is set before comparing
        $selected = isset($row["Roles"]) && $row["Roles"] == $role ? "selected" : "";
